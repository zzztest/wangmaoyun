function showTime() { 
	...
	var startDate = new Date(2017, 01, 26);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Meng:<br>"
		+ "You are my air<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >---Jiangyicheng   2017-05-20</c>"; 
